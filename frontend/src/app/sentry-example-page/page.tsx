    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://kb-konsult-partner-ab.sentry.io/issues/?project=4509204108148816">Issues Page</a>.
